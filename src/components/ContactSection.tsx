    ...
    <section className="py-20 bg-white scroll-mt-[100px]" id="contact">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0">
                  <Mail className="w-3 h-3 md:w-5 md:h-5 text-orange-600" />
                </div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0">
                  <Phone className="w-3 h-3 md:w-5 md:h-5 text-orange-600" />
                </div>
                <div className="text-xs md:text-base">
          ...
          {/* Right Column: Form */}
          <div className="lg:col-span-2 bg-gray-50 rounded-3xl p-3 md:p-8 border border-gray-100">
            <form className="space-y-6">

              {/* Row 1: Name, Email, Phone */}
              <div className="grid md:grid-cols-3 gap-4">
                <div className="space-y-3">
                  <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2 text-xs md:text-base">Nama Lengkap</label>
                ...
                <div className="space-y-3">
                  <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-2 text-xs md:text-base">Email</label>
                ...
                <div className="space-y-3">
                  <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-2 text-xs md:text-base">No. Telepon</label>
              ...
              <div className="space-y-3">
                <label htmlFor="company" className="block text-sm font-medium text-gray-700 mb-2 text-xs md:text-base">Nama Sekolah/Instansi</label>
              ...
              {/* Row 2: Address */}
              <div className="space-y-3">
                <label htmlFor="address" className="block text-sm font-medium text-gray-700 mb-2 text-xs md:text-base">Alamat Lengkap</label>
              ...
              {/* Row 5: Textarea */}
              <div className="space-y-3">
                <label htmlFor="message" className="block text-sm font-medium text-gray-700 mb-2 text-xs md:text-base">Pesan Anda</label>
              ...
              {/* Row 6: File Upload */}
              {/* <div className="space-y-3">
                <label className="block text-sm font-medium text-gray-700 mb-2 text-xs md:text-base">Lampiran</label>
